...
namespace RenderCore.ShapeUtilities
{
    ...
    {
        public static IEnumerable<VertexArrayShape> GetGridDrawableFromView(View _view, float _lineThickness, Vector2 _cellSize)
        {
            ...
            IEnumerable<VertexArrayShape> shapes = ShapeFactory.GetGridShapes(rows, columns, viewSize, _lineThickness, position);
            return shapes;
        }
    }
}